        ...
        <div class="row justify-content-center mx-0">
            <div class="col-lg-10">
                <div class="card border-0">
                    <form autocomplete="off" action="person_center.php" method="post">
                        <div class="card-header bg-dark">
                            <div class="mx-0 mb-0 row justify-content-sm-center justify-content-start px-1">
                                <input type="text" id="dp1" class="datepicker" placeholder="Pick a solt" name="date" readonly><span class="fa fa-calendar"></span>
                            </div>
                        </div>
                        ...
                        <button name="submit" class="btn btn-info" type="submit" style="margin-left: 35em;margin-bottom: 1em;">Submit</button>
                    </form>
                </div>
            </div>
        </div>
